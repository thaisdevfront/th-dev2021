    ...
    return   <div> 
        ...
        <Row className="align-items-center pt-5 pb-4">
          ...
          <ListGroup className="border border-0">
            ...
            <ListGroup.Item href="#portfolio"  className="text-muted border border-0 pt-1 pl-0 ">Portfólio 2021</ListGroup.Item>
            <ListGroup.Item href="curriculum" className="text-muted border border-0 pt-1 pl-0 ">Download do CV</ListGroup.Item>
        ...
        <Row>
          <Col>
            <p className="fw-bolde text-center mt-3">
               Direitos reservados 2021 <strong>Thais Mariano Designer e Desenvolvedora.</strong> 
            </p>
          </Col>
        </Row>
      </Container>
