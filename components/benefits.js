    ...
    <section className="benefits mt-5 pt-md-3 pb-3">
        <Container>
          <Row>
              ...
              <Col  xs={12} md={7} lg={4}  className="justify-content-center align-items-start d-none d-lg-flex pt-md-2"> 
              ...
              <Col xs={12} md={7} lg={4} className="pt-5 p-md-2 pl-md-5 p-lg-0 ">
